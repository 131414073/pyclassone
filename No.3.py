...
def start():
    ...
    print("悟空：嗯，这里妖气十足，可能会有妖怪吧!我们都要小心哪。那个猪儿喃？")
    print("八戒:哎呀！我饿了麻。我要吃肉肉 就要吃肉肉.")
    print("悟空：吃吃吃！就晓得吃！老子一指拇儿do死你")
...
def adventure_room2():
    ...
    print("白骨精：shit！..哎哟奥巴马,马哥，我错了，错了，我不该说你坏话，我不该。。哎？猴子!")
    print("敢骗你老娘！找打。")
